 ...
 */
export type AfricaniesSdkHttpToasts = 'off' | 'errors' | 'all' | Partial<ToastHttpOptions>;
 ...
 * ```
 */
export interface AfricaniesSdkConfig {
  /**
 ...
 * an empty base URL.
 */
export const AFRICANIES_SDK_CONFIG = new InjectionToken<AfricaniesSdkConfig>(
