...
import { AFRICANIES_MODE_CONFIG_KEY, STORAGE_TOKEN } from '@africanies/africanies-storage';
...
export class ModeConfigService {
  ...
  private hydrateFromStorage(): void {
    const stored = this.storage.get<ModeConfigDataModel>(AFRICANIES_MODE_CONFIG_KEY);
