...
import { AFRICANIES_ACCESS_TOKEN_KEY, STORAGE_TOKEN } from '@africanies/africanies-storage';
...
export class AuthTokenService {
  ...
  set(accessToken: string): void {
    ...
    this.storage.set<string>(AFRICANIES_ACCESS_TOKEN_KEY, trimmed);
  }
  ...
  private readInitialToken(): string | null {
    const stored = this.storage.get<string>(AFRICANIES_ACCESS_TOKEN_KEY);
