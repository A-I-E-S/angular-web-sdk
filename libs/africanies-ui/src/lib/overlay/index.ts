 ...
 *
 * Openers implement `@africanies/africanies-core` {@link OverlayOpener} and are bound to
 * {@link MODAL_SERVICE} / {@link DRAWER_SERVICE} via {@link provideAfricaniesUiOverlays}.
 */
export { AfricaniesOverlayRef } from './africanies-overlay-ref';
...
export { provideAfricaniesUiOverlays } from './provide-africanies-ui-overlays';
