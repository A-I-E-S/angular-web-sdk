 ...
 * @example
 * ```html
 * <button africanies-button type="button" variant="primary" (click)="save()">
 *   Save shipment
 * </button>
 *
 * <button africanies-button type="button" variant="ghost-primary" size="sm">
 *   <africanies-icon name="plus" [size]="14" />
 *   Add row
 * </button>
 *
 * <button africanies-button type="button" variant="primary" [loading]="saving()">
 *   Save shipment
 * </button>
 *
 * <button africanies-button type="button" variant="danger" size="sm" [disabled]="busy()">
 *   <africanies-icon name="trash" [size]="16" />
 *   Delete
 * </button>
 * ```
 */
@Component({
  selector: 'button[africanies-button], a[africanies-button]',
  standalone: true,
...
export class ButtonComponent {
  ...
  /**
   * Visual variant. Defaults to `primary` so a bare `africanies-button` reads as the
