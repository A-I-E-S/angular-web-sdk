 ...
 */
@Component({
  selector: 'africanies-file-upload',
  standalone: true,
  changeDetection: ChangeDetectionStrategy.OnPush,
  imports: [AfricaniesIconComponent, ButtonComponent, NgTemplateOutlet],
  providers: [
    {
          ...
          >
            <div class="flex flex-wrap items-center gap-2">
              @if (allowFileSelect()) {
                ...
                >
                  <africanies-icon name="upload" [size]="16" />
                  {{ chooseLabel() }}
                </button>
              }
              @if (allowCamera()) {
        ...
        @default {
          ...
          >
            ...
            >
              ...
              >
                <africanies-icon name="cloud-upload" [size]="24" />
              </span>
...
export class FileUploadComponent implements ControlValueAccessor, OnDestroy {
  ...
  protected readonly controlId = `africanies-file-upload-${++nextFileUploadId}`;
