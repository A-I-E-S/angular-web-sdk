 ...
 * shared AFRICANIES form field pattern.
 *
 ...
 *   [(value)]="pickupDate"
 * >
 *   <africanies-icon prefix name="calendar" [size]="16" />
 * </africanies-date-picker>
 * ```
 */
@Component({
  selector: 'africanies-date-picker',
  standalone: true,
...
export class DatePickerComponent implements ControlValueAccessor {
  ...
  protected readonly controlId = `africanies-date-picker-${++nextDatePickerId}`;
