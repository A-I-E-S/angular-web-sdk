 ...
 * @example
 * ```html
 * <africanies-page-header
 *   title="App Settings"
 *   subtitle="Company control panel for shipping, money, warehouses, staff, and partners."
 * />
 *
 * <africanies-page-header title="Deliveries" subtitle="Inbound freight for this mode.">
 *   <button actions africanies-button type="button" variant="primary">New</button>
 * </africanies-page-header>
 * ```
 */
@Component({
  selector: 'africanies-page-header',
  standalone: true,
