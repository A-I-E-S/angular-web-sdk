...
import { FilterOptionsResolver } from '@africanies/africanies-core';
...
@Component({
  ...
  template: `
    ...
    <div class="flex h-full min-h-0 flex-col -mx-6">
      ...
      <div
        class="africanies-overlay-scroll flex min-h-0 flex-1 flex-col gap-5 overflow-y-auto px-6 pb-5"
      >
