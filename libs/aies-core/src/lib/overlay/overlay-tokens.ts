 ...
 * observe dismissal without depending on `@aies/aies-ui`.
 *
 ...
 *
 * Defined in `aies-core` (and provided from `aies-ui`) so route-driven
...
/**
 * Optional token for the app's modal opener (provided by `@aies/aies-ui`).
 *
...
/**
 * Optional token for the app's drawer opener (provided by `@aies/aies-ui`).
 *
