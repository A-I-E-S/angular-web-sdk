...
@Component({
        ...
        >
          ...
          <div class="min-w-0 flex-1">
            ...
            @if (item().durationMs) {
              ...
              >
                <div
                  class="aies-toast-rail h-full w-full origin-left"
                  [class]="railFillClass()"
  ...
  styles: `
    ...
    .aies-toast-enter {
      animation: aies-toast-in 220ms ease-out both;
    }
    .aies-toast-rail {
      animation-name: aies-toast-rail;
      animation-timing-function: linear;
      animation-fill-mode: forwards;
    }
    :host.is-paused .aies-toast-rail {
...
export class ToastItemComponent {
  ...
  protected readonly shellClass = computed(
    () =>
      'aies-toast-enter relative flex w-full overflow-hidden rounded-lg border border-border ' +
