 ...
 * ```html
 * <!-- Default info icon -->
 * <aies-tooltip text="Paid means the invoice is settled." />
 *
 * <!-- Custom target -->
 * <aies-tooltip text="Required for insured shipments." placement="bottom">
...
@Component({
  ...
  template: `
    ...
    >
      ...
      >
        <ng-content select="[aiesTooltipTrigger]" />
      </span>
...
export class TooltipComponent {
  protected readonly tooltipId = `aies-tooltip-${++nextTooltipId}`;
