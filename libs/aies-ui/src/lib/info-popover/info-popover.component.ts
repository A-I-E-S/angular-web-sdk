 ...
 * @example
 * ```html
 * <aies-info-popover title="Zones Available" placement="top">
 *   <ul aiesInfoPopoverContent class="space-y-1 text-body-sm text-ink">
 ...
 * <aies-info-popover title="Details">
 *   <button type="button" aies-button aiesInfoPopoverTrigger variant="ghost" size="sm">
 *     More
 *   </button>
 *   <app-zone-list aiesInfoPopoverContent [zones]="zones" />
 * </aies-info-popover>
 * ```
 */
@Component({
  selector: 'aies-info-popover',
  standalone: true,
  ...
  template: `
    ...
    >
      ...
      >
        <ng-content select="[aiesInfoPopoverTrigger]" />
      </span>
...
export class InfoPopoverComponent {
  protected readonly panelId = `aies-info-popover-${++nextInfoPopoverId}`;
